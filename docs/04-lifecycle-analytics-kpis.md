...
**Current Probability KPI band** also shows a **Target Underlying** card (alongside Required Underlying). Home Live Notional / Ongoing / Obs-due tiles and Current Prob KPIs use the same **equal-width full-row** band (scroll only when the viewport is too narrow).
