...
- **Current Probability** KPI band includes Target Underlying + Required Underlying; Home Live Notional / Ongoing / Obs-due and Current Prob KPIs share equal-width full-row cards (scroll only when needed)  
