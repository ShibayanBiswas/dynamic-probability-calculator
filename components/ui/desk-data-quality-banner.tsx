  ...
  return (
    <Panel className="!p-5" glow="purple">
      <div className="flex flex-col items-center gap-3 text-center">
        <span className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 text-amber-900 dark:bg-amber-950/40">
          <AlertTriangle className="h-6 w-6" aria-hidden />
        </span>
        <p className="text-sm font-bold uppercase tracking-[0.18em] text-amber-900">{headline}</p>
